                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex flex-wrap gap-2">
                            <button class="btn btn-sm btn-primary add-btn" onclick="add()"><i
                                    class="fas fa-plus me-1"></i> Tambah Kategori</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="text" name="icon" id="icon" class="form-control"
                                    placeholder="Masukkan class icon (Contoh: fas fa-box)" />
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    table = $('#table').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'category_name', // Update ke field database yang sesuai
                orderable: false,
            },
            {
                data: 'status',
...
function add() {
    ...
    $('#form')[0].reset();
    var form = $('#form input, #form textarea');
