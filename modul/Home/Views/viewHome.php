                            ...
                            <div class="d-flex flex-column gap-3 gap-lg-4">
                                <div
                                    ...
                                    <div class="nav flex-column gap-2 min-w-0 p-3">
                                        <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0"
                                            ...
                                            <span class="animate-target text-truncate">Short jacket in long-pile faux
                                                fur</span>
                                        </a>
                                ...
                                <div
                                    ...
                                    <div class="nav flex-column gap-2 min-w-0 p-3">
                                        <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0"
                                            href="shop-product-fashion.html">
                                            <span class="animate-target text-truncate">Classic aviator sunglasses for
                                                women</span>
                                        </a>
                            ...
                            <div class="d-flex flex-column gap-3 gap-lg-4">
                                <div
                                    ...
                                    <div class="nav flex-column gap-2 min-w-0 p-3">
                                        <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0"
                                            href="shop-product-fashion.html">
                                            <span class="animate-target text-truncate">Vintage oversized wool blazer
                                                jacket</span>
                                        </a>
                                ...
                                <div
                                    ...
                                    <div class="nav flex-column gap-2 min-w-0 p-3">
                                        <a class="nav-link text-dark-emphasis stretched-link w-100 min-w-0 p-0"
                                            href="shop-product-fashion.html">
                                            <span class="animate-target text-truncate">Classic pilot style polarized
                                                sunglasses</span>
                                        </a>
