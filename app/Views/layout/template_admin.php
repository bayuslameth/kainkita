...
<head>
    ...
    <link rel="stylesheet" href="/assets_admin/compiled/css/app.css">
    <link rel="stylesheet" href="/assets_admin/compiled/css/app-dark.css">
    <link rel="stylesheet" href="/assets_admin/compiled/css/iconly.css">
...
<body>
    <script src="/assets_admin/static/js/initTheme.js"></script>
    <div id="app">
        <div id="sidebar">
    ...
    <script src="/assets_admin/extensions/apexcharts/apexcharts.min.js"></script>
    <script src="/assets_admin/static/js/pages/dashboard.js"></script>
    ...
    function showblockUI() {
        jQuery.blockUI({
            message: 'Bentar ya, lagi nyiapin datanya nih...',
            baseZ: 2000,
            css: {
                border: 'none',
                padding: '15px',
